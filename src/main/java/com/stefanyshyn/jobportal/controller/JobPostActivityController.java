...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        searchingModel(model, job, location, partTime, today, days7, days30);
    ...
    private static void searchingModel(Model model, String job, String location, String partTime, boolean today, boolean days7, boolean days30) {
